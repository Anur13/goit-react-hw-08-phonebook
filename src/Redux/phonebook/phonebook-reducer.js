...
const phonebookReducer = createReducer([], {
  ...
  [submitDeleteItemSuccess]: (state, { payload }) =>
...
const loaderReducer = createReducer(false, {
  ...
  [submitSignUpSuccess]: () => false,
  [submitSignUpError]: () => false,

  [submitLoginRequest]: () => true,
  [submitLoginSuccess]: () => false,
  [submitLoginsError]: () => false,

  [submitLogOutRequest]: () => true,
  [submitLogOutSuccess]: () => false,
  [submitLogOutsError]: () => false,

  [submitGetCurrentUserRequest]: () => true,
  [submitGetCurrentUserSuccess]: () => false,
  [submitGetCurrentUsesError]: () => false,
});
